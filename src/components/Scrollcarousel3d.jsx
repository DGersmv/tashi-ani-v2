...
const CARD_W = 800;        // ширина карточки в px
const CARD_H = 600;        // высота карточки в px
const STEP_X = 320;        // шаг между карточками по X
const STEP_Y = -120;       // шаг между карточками по Y
const STEP_Z = -250;       // шаг между карточками по Z (глубина)
const LINE_X = -210;       // смещение линии: < 0 влево, > 0 вправо
const LINE_Y = -20;         // смещение линии: < 0 вверх, > 0 вниз
